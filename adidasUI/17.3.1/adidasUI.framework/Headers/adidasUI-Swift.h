...
+ (NSArray<NSLayoutConstraint *> * _Nonnull)constraintsWithVisualFormat:(NSString * _Nonnull)format optionalMetrics:(NSDictionary<NSString *, id> * _Nullable)optionalMetrics views:(NSDictionary<NSString *, id> * _Nonnull)views;
+ (NSLayoutConstraint * _Nonnull)equalWidthWithItem:(UIView * _Nullable)view1 toItem:(UIView * _Nullable)view2 multiplier:(CGFloat)multiplier constant:(CGFloat)c;
