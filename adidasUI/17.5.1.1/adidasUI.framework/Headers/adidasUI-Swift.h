...
@interface AUICardCvvInputView (SWIFT_EXTENSION(adidasUI))
@end
...
@interface AUICardExpDateInputView (SWIFT_EXTENSION(adidasUI))
@end
...
@interface AUICardNumberInputView (SWIFT_EXTENSION(adidasUI))
@end
...
@interface AUIEndlessPickerView (SWIFT_EXTENSION(adidasUI))
@end
...
@interface AUIModalOverlayContainer (SWIFT_EXTENSION(adidasUI))
@end
...
@interface AUITextInputField (SWIFT_EXTENSION(adidasUI))
@end
...
@protocol AUITextInputFieldDelegate <AUIInputViewDelegate>
@optional
...
@interface NSAttributedString (SWIFT_EXTENSION(adidasUI))
@end


@interface NSLayoutConstraint (SWIFT_EXTENSION(adidasUI))
+ (NSArray<NSLayoutConstraint *> * _Nonnull)constraintsWithVisualFormat:(NSString * _Nonnull)format optionalMetrics:(NSDictionary<NSString *, id> * _Nullable)optionalMetrics views:(NSDictionary<NSString *, id> * _Nonnull)views SWIFT_WARN_UNUSED_RESULT;
+ (NSLayoutConstraint * _Nonnull)equalWidthWithItem:(UIView * _Nullable)view1 toItem:(UIView * _Nullable)view2 multiplier:(CGFloat)multiplier constant:(CGFloat)c SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithItem:(id _Nonnull)view1 attribute:(NSLayoutAttribute)attr1 relatedBy:(NSLayoutRelation)relation toItem:(id _Nullable)view2 attribute:(NSLayoutAttribute)attr2;
@end


@interface UIColor (SWIFT_EXTENSION(adidasUI))
...
@interface UIView (SWIFT_EXTENSION(adidasUI))
- (UIView * _Nullable)copyView SWIFT_WARN_UNUSED_RESULT;
@end
